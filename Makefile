#############################################################################
# Makefile for building: ComAudio
# Generated by qmake (2.01a) (Qt 4.7.0) on: Tue Mar 8 16:01:27 2011
# Project:  ComAudio.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile ComAudio.pro
#############################################################################
...
Makefile: ComAudio.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
		/usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/qconfig.pri \
		/usr/share/qt4/mkspecs/modules/qt_webkit_version.pri \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/ComAudio1.0.0 || $(MKDIR) .tmp/ComAudio1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/ComAudio1.0.0/ && $(COPY_FILE) --parents mainwindow.h textClient.h textServer.h socket.h settings.h includes.h thread.h component.h .tmp/ComAudio1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp textClient.cpp textServer.cpp socket.cpp settings.cpp thread.cpp component.cpp .tmp/ComAudio1.0.0/ && $(COPY_FILE) --parents mainwindow.ui settings.ui .tmp/ComAudio1.0.0/ && (cd `dirname .tmp/ComAudio1.0.0` && $(TAR) ComAudio1.0.0.tar ComAudio1.0.0 && $(COMPRESS) ComAudio1.0.0.tar) && $(MOVE) `dirname .tmp/ComAudio1.0.0`/ComAudio1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/ComAudio1.0.0
...
moc_textClient.cpp: socket.h \
		component.h \
		textClient.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) textClient.h -o moc_textClient.cpp

moc_textServer.cpp: socket.h \
		component.h \
		textServer.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) textServer.h -o moc_textServer.cpp

moc_socket.cpp: socket.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) socket.h -o moc_socket.cpp

moc_settings.cpp: settings.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) settings.h -o moc_settings.cpp

moc_component.cpp: component.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) component.h -o moc_component.cpp
