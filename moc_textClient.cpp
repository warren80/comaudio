...
static const char qt_meta_stringdata_TextClient[] = {
    "TextClient\0\0signalTextRecieved(TextReceived*)\0"
    "slotTextRecieved(char*)\0Start()\0"
};
...
int TextClient::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: signalTextRecieved((*reinterpret_cast< TextReceived*(*)>(_a[1]))); break;
        case 1: slotTextRecieved((*reinterpret_cast< char*(*)>(_a[1]))); break;
        case 2: Start(); break;
        default: ;
        }
        _id -= 3;
...
// SIGNAL 0
void TextClient::signalTextRecieved(TextReceived * _t1)
{
